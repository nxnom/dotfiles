...
-- Insert keymap
keymap.set('i', '<C-;>', '<Esc>A;<Esc>', { noremap = true }) -- work in kitty
keymap.set('i', '<A-;>', '<Esc>A;<Esc>', { noremap = true }) -- work in tmux inside kitty
keymap.set('i', '<C-d>', '<Esc>A<Enter>', { noremap = true })
